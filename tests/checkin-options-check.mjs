...
if (!sw.includes("CACHE_NAME = 'marsb-gym-v83-mobile-fluidity-stage1'")) {
...
console.log('OK: opções visíveis 1–10, seleção acessível, salvamento retrocompatível, toque mínimo e cache v83 validados.');
