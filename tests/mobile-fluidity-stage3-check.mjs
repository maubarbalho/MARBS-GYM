...
const refreshEnd = html.indexOf('function repeatLastGuidedSet', refreshStart);
...
console.log('OK: Etapa 3, atualização parcial das séries guiadas, acessibilidade, guidedBody preservado e cache v88 validados.');
